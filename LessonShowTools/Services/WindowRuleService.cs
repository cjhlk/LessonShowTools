...
public class WindowRuleService : IWindowRuleService
{
    ...
    public WindowRuleService(ILogger<WindowRuleService> logger, IRulesetService rulesetService)
    {
        ...
        RulesetService.RegisterRuleHandler("LessonShowTools.windows.className", ClassNameHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.windows.text", TextHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.windows.status", StatusHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.windows.processName", ProcessNameHandler);
    }
    ...
    public unsafe bool IsForegroundWindowLessonShowTools()
    {
        uint pid = 0;
        GetWindowThreadProcessId(ForegroundHwnd, &pid);
        var process = Process.GetProcessById((int)pid);
