...
using LessonShowTools.Core.Models.Theming;
    ...
    public void SetTheme(int themeMode, Color primary, Color secondary)
    {
        ...
        var resource = new ResourceDictionary
        {
            Source = CurrentRealThemeMode == 0 ?
                new Uri("pack://application:,,,/LessonShowTools;component/Themes/LightTheme.xaml") :
                new Uri("pack://application:,,,/LessonShowTools;component/Themes/DarkTheme.xaml")
        };
