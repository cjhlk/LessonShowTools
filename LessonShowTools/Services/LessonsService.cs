...
public class LessonsService : ObservableRecipient, ILessonsService
{
    ...
    public LessonsService(SettingsService settingsService, IProfileService profileService, ILogger<LessonsService> logger, IExactTimeService exactTimeService, IRulesetService rulesetService, IIpcService ipcService)
    {
        ...
        RulesetService.RegisterRuleHandler("LessonShowTools.lessons.timeState", TimeStateHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.lessons.currentSubject", CurrentSubjectHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.lessons.nextSubject", NextSubjectHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.lessons.previousSubject", PreviousSubjectHandler);
