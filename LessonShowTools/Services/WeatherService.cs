...
public class WeatherService : IHostedService, IWeatherService
{
    ...
    public WeatherService(SettingsService settingsService, ILogger<WeatherService> logger, IRulesetService rulesetService)
    {
        ...
        LoadData();
        RulesetService.RegisterRuleHandler("LessonShowTools.weather.currentWeather", CurrentWeatherRuleHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.weather.hasWeatherAlert", HasAlertRuleHandler);
        RulesetService.RegisterRuleHandler("LessonShowTools.weather.rainTime", RainTimeRuleHandler);
    ...
    public async Task QueryWeatherAsync()
    {
        ...
        //    //var uri =  $"https://weatherapi.market.xiaomi.com/wtr-v3/location/city/info?locationKey={Settings.CityId}&locale=zh_cn";
