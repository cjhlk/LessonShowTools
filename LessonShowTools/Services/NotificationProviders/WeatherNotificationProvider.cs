...
using LessonShowTools.Controls.NotificationProviders;
...
namespace LessonShowTools.Services.NotificationProviders;
...
public class WeatherNotificationProvider : INotificationProvider, IHostedService
{
        ...
        IActionService actionService)
    {
        ...
        ActionService.RegisterActionHandler("LessonShowTools.notification.weather", (settings, _) => 
