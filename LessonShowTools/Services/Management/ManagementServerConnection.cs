...
using LessonShowTools.Shared.Protobuf.Client;
using LessonShowTools.Shared.Protobuf.Enum;
using LessonShowTools.Shared.Protobuf.Server;
using LessonShowTools.Shared.Protobuf.Service;
...
namespace LessonShowTools.Services.Management;
