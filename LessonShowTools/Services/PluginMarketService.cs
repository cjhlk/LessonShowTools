...
private ObservableDictionary<string, PluginInfo> _mergedPlugins = new();
    ...
    private IEnumerable<PluginIndexInfo> GetIndexInfos()
    {
        ...
        var repo = "{root}/LessonShowTools/PluginIndex/releases/download/latest/index.zip".Replace("{root}", mirrors[SettingsService.Settings.OfficialSelectedMirror ?? "github"]);
