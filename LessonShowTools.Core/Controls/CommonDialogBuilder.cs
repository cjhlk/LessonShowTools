...
namespace LessonShowTools.Core.Controls;
...
public class CommonDialogBuilder
{
    ...
    public CommonDialogBuilder SetIconKind(CommonDialogIconKind kind)
    {
        ...
        return managementService?.Policy.DisableEasterEggs == true
            ...
            : kind switch
            {
                CommonDialogIconKind.Information => SetBitmapIcon(new Uri("/Assets/AppLogo.png",
                    UriKind.RelativeOrAbsolute)),
                CommonDialogIconKind.Hint => SetBitmapIcon(new Uri("/Assets/AppLogo.png",
                    UriKind.RelativeOrAbsolute)),
                CommonDialogIconKind.Forbidden => SetBitmapIcon(new Uri("/Assets/AppLogo.png",
                    UriKind.RelativeOrAbsolute)),
                CommonDialogIconKind.Error => SetBitmapIcon(new Uri("/Assets/AppLogo.png",
                    UriKind.RelativeOrAbsolute)),
                _ => throw new ArgumentOutOfRangeException(nameof(kind), kind, null)
            };
    }
