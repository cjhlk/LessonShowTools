...
using ClassInfo = LessonShowTools.Shared.Models.Profile.ClassInfo;
using Profile = LessonShowTools.Shared.Models.Profile.Profile;
using Subject = LessonShowTools.Shared.Models.Profile.Subject;

namespace LessonShowTools.Shared.Extensions;
...
public static class CsesExtensions
{
    ...
    /// <summary>
    /// 将 CSES 格式的课表转换为 LessonShowTools 格式的课表。
    /// </summary>
    /// <param name="profile">CSES 格式课表</param>
    /// <param name="mergeProfile">需要合并的 LessonShowTools 课表</param>
    /// <returns>LessonShowTools 格式课表</returns>
    public static Profile ToLessonShowToolsObject(this CsesSharp.Models.Profile profile, Profile? mergeProfile=null)
    {
    ...
    /// <summary>
    /// 将 LessonShowTools 格式的课表转换为 CSES 格式的课表。
    /// </summary>
    /// <param name="profile">LessonShowTools 格式课表</param>
